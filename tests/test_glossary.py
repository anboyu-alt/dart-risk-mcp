...
# 않고 사유를 남긴 채 제외한다 — 다음 과제의 문구 재작성이 이 낱말을
# 쓰게 되면 이 목록에서 뺀다.
#
# "연결/별도": SIGNAL_PROSE 등에는 "연결"과 "별도"가 각각 따로(예: "연결
# 순이익이 별도보다…") 등장할 뿐, "연결/별도"라는 붙은 표기가 그대로
# 나오는 곳이 없다(2026-09 실측). 다음 과제가 이 조합 표기를 실제로
# 쓰게 되면 이 표제어를 목록에서 뺀다.
_PENDING_REWRITE = {"연결/별도"}
