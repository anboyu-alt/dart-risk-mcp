...
관측 타임라인 · 신호 해설 · 최대주주 변경 상세 · 손익구조 급변 · 재무 핵심 · 회전율 추세 · 메자닌(CB·BW·EB) 현황 · 주식 수 변동(희석) · 배당과 순이익 · 조달 자금의 행방 · 임원·주요주주 소유보고 시계열 · 감사의견 3개년 · 채무증권 미상환 잔액 · **공시와 시장**(1년 종가·거래량 위에 관찰 신호 마커와 코스피·코스닥 지수를 겹친 차트 + 사건별 전후 대조표 — 본인의 KRX Open API 키가 있을 때만, 약관상 운영자 키로는 조회하지 않습니다).
