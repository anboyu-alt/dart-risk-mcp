...
한국 상장기업의 공시를 AI(Claude)가 자동으로 분석해서 투자 위험 신호를 알려주는 도구입니다.

> **MCP란?** Claude AI가 외부 데이터를 직접 가져와 분석할 수 있게 연결해 주는 방식입니다.  
> 이 MCP를 설치하면 Claude에게 **"삼성바이오로직스 최근 공시 위험도 분석해줘"** 라고 물어볼 수 있습니다.
...
이 도구는 그런 패턴을 자동으로 찾아서 **"지금 이 기업에서 무슨 일이 벌어지고 있는지"** 를 Claude가 설명하게 해줍니다.
...
설치가 완료되면 Claude에게 자연어로 바로 물어볼 수 있습니다.
...
Claude Desktop에서 새 대화를 시작하고, 채팅창 **왼쪽 아래의 망치(🔨) 아이콘**을 클릭합니다.  
아래 세 가지 도구가 목록에 보이면 설치 성공입니다:
